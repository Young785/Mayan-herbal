    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="/pages/register">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" type="number" name="phone" value="{{ old('phone') }}"  type="text" required="" placeholder="Phone Number">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="vendor" id="customCheck2">
                                    <label class="custom-control-label" for="customCheck2">Optional! Do you wish to be our <a href="/main/vendors">advertiser</a> ? mark the checkbox</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">I agree to all <a href="https://drive.google.com/file/d/1bD_AARFbnGH-uExB3YTIzQuto2PUQuSU/view?usp=sharing">Terms and Conditions</a></label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Already have an account? <a href="/pages/login" class="text-info m-l-5"><b>Sign In</b></a>
                            </div>
                        </div>
                    </form>
                </div>
