                                        ...
                                        @foreach ($users as $user)
                                            ...
                                            @endif
                                                ...
                                                <td>
                                                    @if ($user->vendor_request =="Yes")
                                                        <a  data-toggle="modal" data-target="#vendor{{$user->id}}" class="btn btn-outline-success text-success btn-sm">Make Vendor</a>
                                                        <p></p>
                                            ...
                                            <div id="delete{{$user->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                <div class="modal-dialog">
                                                    ...
                                                    <!-- modal daModal-->
                                                    <div id="vendor{{$user->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Edit Account</h4>
                                                                ...
                                                                <form method="POST" action="/users/make-vendor/{{$user->id}}">
                                                                <div class="modal-body">
                                                                        ...
                                                                        <div class="alert alert-success" role="alert">
                                                                            Are you sure you want to make this user a Vendor??
                                                                        </div>
        
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                                                                    <button type="submit" class="btn btn-success waves-effect waves-light">Make Vendor</button>
