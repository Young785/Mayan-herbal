    ...
    <section id="wrapper">
        <div class="login" style="background-image:url(../assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    @if (Session()->has("msg"))
                        <div class="text-center" id="timeOut">
                            <div class="btn btn-danger">Incorrect email or password!</div>
                        </div>
                    @endif
                    @if (Session()->has("notAllowed"))
                        <div class="text-center" id="timeOut">
                            <div class="btn btn-danger">No Access is allowed!</div>
                        </div>
                    @endif
                    @if (Session()->has("mustLogin"))
                        <div class="text-center" id="timeOut">
                            <div class="btn btn-danger">Please login to confirm your request!</div>
                        </div>
                    @endif
                    <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                Don't have an account? <a href="/pages/register" class="text-info m-l-5"><b>Sign Up</b></a>
                            </div>
                        </div>
                    </form>
