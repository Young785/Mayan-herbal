    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(../assets/images/background/login-register.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" method="POST" action="/pages/register?ref={{$refer}}">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="ref_by" value="{{$refer}}" type="text" placeholder="Referrer (Optional)">
                            </div>
                        </div>
