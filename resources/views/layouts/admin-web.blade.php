            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/app-accounts" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard </span></a>

                        </li>
                        <li> <a class="waves-effect waves-dark" href="/users" aria-expanded="false"><i class="ti-user"></i><span class="hide-menu">Users</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="/vendors" aria-expanded="false"><i class="ti-user"></i><span class="hide-menu">Vendors</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="/orders" aria-expanded="false"><i class="ti-user"></i><span class="hide-menu">Orders</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-rocket"></i>Categories
                            ...
                            <div id="submenu-1" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/add-category">Add Category<span class="badge badge-secondary">New</span></a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-cart-plus"></i>Products
                                <i class="fa fa-angle-down"></i>
                            </a>
                            <div id="submenu-2" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="/add-products">Add Products<span class="badge badge-secondary">New</span></a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/site-contents" aria-expanded="false"><i class="ti-book"></i><span class="hide-menu">Site Content</span></a>
                        </li>
                            <ul aria-expanded="false" class="collapse">
