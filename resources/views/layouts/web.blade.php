            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class=" has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Activities</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="/index/orders">Your Orders</a></li>
                                <li><a href="/index/save-for-later">Save for Later</a></li>

                            </ul>
                        </li>
                        @if (Auth::user()->user_type == "vendor")
                        <li> <a class="waves-effect waves-dark" href="/vendor/orders" aria-expanded="false"><i class="ti-wallet"></i><span class="hide-menu">Orders</span></a>
